...
function(a, e, t) {
    riot = a("riot"),
    riot.tag("conversion-analysis-by-area-tag", '<div class="body-inner"> <div class="nav-bar"> <span class="icon icon-eye" onclick="{showLoginHistory}"></span> <a class="icon icon-back" href="/view/campaign/-/1"></a> <span class="icon icon-menu" onclick="{toggleAppMenu}"></span> <h2>Conversion Report</h2> <h3>Total Amount of Conversion by Area</h3> </div> </div> <div class="category"> <a href="/view/campaign/conversion-analysis-by-area/-/1/event"> <div class="bee-cell small {active: type == \'event\'}"> <div class="top"></div> <div class="mid"></div> <div class="bot"></div> <div class="content"> <div class="inner"> Event </div> </div> </div> </a> <a href="/view/campaign/conversion-analysis-by-area/-/1/store"> <div class="bee-cell small {active: type == \'store\'}"> <div class="top"></div> <div class="mid"></div> <div class="bot"></div> <div class="content"> <div class="inner"> Store </div> </div> </div> </a> <a href="/view/campaign/conversion-analysis-by-area/-/1/city"> <div class="bee-cell small {active: type == \'city\'}"> <div class="top"></div> <div class="mid"></div> <div class="bot"></div> <div class="content"> <div class="inner"> City </div> </div> </div> </a> <a href="/view/campaign/conversion-analysis-by-area/-/1/country"> <div class="bee-cell small {active: type == \'country\'}"> <div class="top"></div> <div class="mid"></div> <div class="bot"></div> <div class="content"> <div class="inner"> Country </div> </div> </div> </a> </div> <div id="conversion-analysis-by-area-chart" style="height: 200px;"> </div> <div class="desc"> Did not Convert: Did not Take Any Conversion Action.<br > To Wechat: Action to Follow Wechat.<br > To Store: Click to E-commerce/Store Locator.<br > To Share: Share on momment and to friend. </div>', ".body-sb-mod--campaign-conversion-analysis-by-area .campaign-menu { -webkit-transform: translateY(0); transform: translateY(0); } .sb-mod.sb-mod--campaign-conversion-analysis-by-area { padding-bottom: 60px; } .sb-mod.sb-mod--campaign-conversion-analysis-by-area .category { text-align: center; margin-top: 20px; }",
    function(e) {
        var t, n, i, o, s, r;
        n = a("app"),
        r = a("skateboard"),
