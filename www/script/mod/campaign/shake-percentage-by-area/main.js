...
function(e, a, t) {
    riot = e("riot"),
    riot.tag("shake-percentage-by-area-tag", '<div class="body-inner"> <div class="nav-bar"> <span class="icon icon-eye" onclick="{showLoginHistory}"></span> <a class="icon icon-back" href="/view/campaign/-/1"></a> <span class="icon icon-menu" onclick="{toggleAppMenu}"></span> <h2>Interest Report</h2> <h3>Total Percentage of Shake by Area</h3> </div> </div> <div class="category"> <a href="/view/campaign/shake-percentage-by-area/-/1/event"> <div class="bee-cell small {active: type == \'event\'}"> <div class="top"></div> <div class="mid"></div> <div class="bot"></div> <div class="content"> <div class="inner"> Event </div> </div> </div> </a> <a href="/view/campaign/shake-percentage-by-area/-/1/store"> <div class="bee-cell small {active: type == \'store\'}"> <div class="top"></div> <div class="mid"></div> <div class="bot"></div> <div class="content"> <div class="inner"> Store </div> </div> </div> </a> <a href="/view/campaign/shake-percentage-by-area/-/1/city"> <div class="bee-cell small {active: type == \'city\'}"> <div class="top"></div> <div class="mid"></div> <div class="bot"></div> <div class="content"> <div class="inner"> City </div> </div> </div> </a> <a href="/view/campaign/shake-percentage-by-area/-/1/country"> <div class="bee-cell small {active: type == \'country\'}"> <div class="top"></div> <div class="mid"></div> <div class="bot"></div> <div class="content"> <div class="inner"> Country </div> </div> </div> </a> </div> <div id="shake-percentage-by-area-chart" style="height: 200px;"> </div> <div class="highest"> <label>Highest Total Shake:</label> <span class="number">{data[0][1]}%</span>. <span class="name">{data[0][0]}</span> </div> <div class="desc"> Total Shake: Total No. of Valid Shakes<br > Unique Shake: Total No. of Shaked Users </div>', ".body-sb-mod--campaign-shake-percentage-by-area .campaign-menu { -webkit-transform: translateY(0); transform: translateY(0); } .sb-mod.sb-mod--campaign-shake-percentage-by-area { padding-bottom: 60px; } .sb-mod.sb-mod--campaign-shake-percentage-by-area .category { text-align: center; margin-top: 20px; } .sb-mod.sb-mod--campaign-shake-percentage-by-area .highest { text-align: center; font-size: 0.9rem; margin-bottom: 10px; } .sb-mod.sb-mod--campaign-shake-percentage-by-area .highest .number { font-size: 1.3rem; color: #90c122; } .sb-mod.sb-mod--campaign-shake-percentage-by-area .highest .name { color: #fff; }",
    function(a) {
        var t, i, s, r, n;
        i = e("app"),
        n = e("skateboard"),
